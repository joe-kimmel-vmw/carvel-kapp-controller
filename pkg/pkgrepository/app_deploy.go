...
func (a *App) deploy(tplOutput string) exec.CmdRunResult {
	...
	case dep.Kapp != nil:
		...
		return kapp.Deploy(tplOutput, a.app.Name+appSuffix, a.startFlushingAllStatusUpdates, func(exec.CmdRunResult) {})
...
func (a *App) delete() exec.CmdRunResult {
	...
	if !a.app.Spec.NoopDelete {
		...
		case dep.Kapp != nil:
			...
			result = kapp.Delete(a.app.Name+appSuffix, a.startFlushingAllStatusUpdates, func(exec.CmdRunResult) {})
